...
<p className="text-base sm:text-lg text-muted-foreground leading-relaxed max-w-xl">
  Kelo helps people in your company get answers anytime, without waiting on
  others, while you control who can access what.
</p>
...
>
  ...
  <img src="/hero-image-1.svg" alt="Hero Image" className="w-full h-full object-contain" />
              </div>
            </div>
          </div>
        </section>
