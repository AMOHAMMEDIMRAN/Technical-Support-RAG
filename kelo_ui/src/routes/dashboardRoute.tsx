...
import FirewallPage from "@/presentation/views/dashboard/FirewallPage";
...
export const dashboardRoute = createRoute({
  ...
  beforeLoad: async () => {
    ...
    if (user.role !== UserRole.CEO && user.role !== UserRole.SUPER_ADMIN) {
...
// Firewall route
export const dashboardFirewallRoute = createRoute({
  getParentRoute: () => dashboardRoute,
  path: "/firewall",
